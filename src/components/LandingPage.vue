<template>
  <div class="landing-page">
    <section class="hero-section">
      <header class="header">
        ...
        <div class="link-container">
          <a href="#" class="link">{{ $t('Sponsor')}}</a>
          <a href="#" class="link outlined">{{ $t('Share')}}</a>
    ...
    <section class="about-section">
      ...
      <div class="cards">
        <div class="card">
          ...
          <p>{{ $t('"Transmission" shows how our choices define our reality. And we choose what is best for us when we are in balance.')}}</p>
        </div>
        <div class="card">
          <img src="../../src/assets/landing/icons/icon2.png" alt class="icon" />
          <p>{{ $t('After the experience, you receive a tailored message that shows your emotional state after the pandemic..')}}</p>
        </div>
        <div class="card">
    ...
    <section class="heal-stories">
      ...
      <div class="content">
        <p>{{ $t('We believe that a good story can shape the world. If you resonate with our cause, help us gather stories from all over the globe and tell them. Transmission 2.0 will tell real stories from the Pandemic.')}}'</p>
        <p>{{ $t('Besides from telling stories, we can also heal stories from all over the world. Choose here which story you want to embrace and regenerate!')}}</p>
...
.hero-section {
  background: url("../../src/assets/landing/hero-bg.png") no-repeat $black
    center;
...
.about-section {
  background: url("../../src/assets/landing/about-bg.png") no-repeat $black
    center;
  background-size: cover;
  width: 100vw;
  height: 100vh;
...
.heal-stories {
  background: url("../../src/assets/landing/heal-bg.png") no-repeat $black
    center;
  background-size: cover;
  width: 100vw;
  height: 100vh;
