  ...
  <div class="landing-page">
    <section class="hero-section">
      <header class="header">
        <div class="logo-container">
          <img src="../../src/assets/landing/TTTT.png" alt class="logo" />
          transmission
        </div>
      ...
      <div class="content">
        ...
        <p>
          {{
            $t("A two minute experience designed to spread positive messages")
          }}
        </p>
      ...
      <div class="content-mobile">
        <img
          src="../../src/assets/landing/landing-phone.png"
          alt
          class="landing-phone"
        />
    ...
    <section class="world-map-section" id="world-map">
      ...
      <a
        href="#"
        class="scroll-btn"
        @click.prevent="scrollToView('#about-section')"
      >
        <span></span>Scroll</a
      >
    </section>
    ...
    <section class="about-section" id="about-section">
      ...
      <p>
        {{
          $t(
            "We want to spread positive messages and create a global conversation"
          )
        }}
      </p>
      ...
      <div class="cards">
        <div class="card">
          <img
            src="../../src/assets/landing/icons/icon1.png"
            alt
            class="icon"
          />
          <p>
        ...
        <div class="card">
          <img
            src="../../src/assets/landing/icons/icon2.png"
            alt
            class="icon"
          />
          <p>
        ...
        <div class="card">
          <img
            src="../../src/assets/landing/icons/icon3.png"
            alt
            class="icon"
          />
          <p>
        ...
        <div class="card">
          <img
            src="../../src/assets/landing/icons/icon4.png"
            alt
            class="icon"
          />
          <p>
    ...
    <section class="sharer-section">
      ...
      <a href="#" class="btn" @click.prevent="startGame">{{
        $t("Play it now")
      }}</a>
      ...
      <footer class="footer">
        <div class="logo-container">
          <img
            src="../../src/assets/landing/TTTT.png"
            alt="transmission"
            class="logo"
          />
