<template>
  <article class="form">
    <div class="heading">
      <h2>{{ $t('Join the Global Conversation') }}</h2>
    ...
    <div class="form-container">
      ...
      <div class="form__group">
        <div class="form__form">
          <p>
            {{ $t('Share your best or worst choices in the Pandemic.') }}
            <br />
            {{ $t('We will publish them in our social midia!') }}
          </p>
  ...
  export default {
    ...
    methods: {
      ...
      validation() {
        ...
        const story = document.querySelector('#form__story')

        const validName = name.checkValidity()
        const validEmail = email.checkValidity()
        const validStory = story.checkValidity()

        if (validName && validEmail && validStory) {
